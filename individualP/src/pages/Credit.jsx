  ...
  return (
    ...
    <div className='mt-4 ml-[420px] '>
      ...
      <Accordion open={open === 1}>
        ...
        <AccordionBody>
        Material Tailwind is an open-source library that uses the power of Tailwind CSS and 
        React to help you build unique web projects faster and easier. 
        The stunning design inspired by Material Design is a bonus!
        <br />
